...
@section('main')
<div class="col-md-8 col-sm-12 bg-white p-4" style="border-radius: 6px;">
...
@section('sidebar')
<div class="col-md-3 ml-md-5 col-sm-12 bg-white p-4" style="height:120px; margin-left:40px; border-radius: 6px;" !important>
    <div class="form-group">
        <label>Upload</label>
